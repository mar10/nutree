...
latex_documents = [
  (master_doc, 'nutree.tex', u'nutree Documentation',
...
man_pages = [
    (master_doc, 'nutree', u'nutree Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'nutree', u'nutree Documentation',
   author, 'nutree', 'One line description of project.',
   'Miscellaneous'),
]
